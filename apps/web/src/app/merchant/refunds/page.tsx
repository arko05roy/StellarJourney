    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Initiate a refund from a payment's row on the Payments page. Every refund here is tracked
          to its original payment, full or partial.
        </p>
      </div>
      {refunds.length === 0 ? (
        <EmptyState
          ...
          description="Refunds you issue from a payment's row will appear here."
        />
      ) : (
